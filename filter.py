...
baseattack=int(sys.argv[1])
basedefence=int(sys.argv[2])
basestamina=int(sys.argv[3])

maxivmissing=int(sys.argv[4])
minattackiv=int(sys.argv[5])
mindefenceiv=int(sys.argv[6])
minstaminaiv=int(sys.argv[7])
allcp=[]
